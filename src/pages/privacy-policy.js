  ...
  return (
    <>
      <GatsbySeo
        ...
        canonical={`https://highlights.mustbefamily.com/privacy-policy`}
        openGraph={{
          url: "https://highlights.mustbefamily.com/privacy-policy",
        }}
      />
      <div className={`bg-black text-white px-5 w-full pt-16 lg:pt-28 pb-5`}>
        <div className={`prose lg:prose-xl prose-invert max-w-5xl md:mx-auto`}>
          ...
          <p>
            Настоящий документ &laquo;Политика конфиденциальности&raquo; (далее
            по тексту &ndash; &laquo;Политика&raquo;) представляет собой правила
            использования Касторским Ильей Вячеславовичем (далее &ndash;
            ...
            https://highlights.mustbefamily.com (далее &ndash;
            &laquo;Сайт&raquo;).
          </p>
          ...
          <p>
            ...
            в обезличенной форме (далее &ndash; &laquo;Обезличенные
            данные&raquo;).
          </p>
          <p>
