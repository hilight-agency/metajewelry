...
const IndexPage = ({ data }) => {
    ...
    return (
      <>
        <Link className={`px-5 md:px-0 cursor-pointer`} to={to}>
          <div
            className={`before:relative before:pt-[100%] before:inline-block before:content-[''] before:w-1 before:h-0 bg-cover relative`}
            style={styleObj}
          >
            <div
            ...
            >
              <div
                className={`mb-[10%] lg:mb-[20%] flex flex-col justify-around items-center`}
              >
                <span className={`text-white uppercase pb-3 lg:pb-5`}>
                  {label}
                </span>
                <span
                  className={`text-white font-bold border border-white rounded-full text-sm pt-0.5 px-3 uppercase`}
                >
                  {t({ id: `index.explore` })}
                </span>
              </div>
  ...
  return (
    <>
      ...
      />
      <div
        className={`absolute top-0 -z-10 left-0 react-player-wrapper w-full h-screen`}
      >
        <ReactVideo
          width="100%"
          height="100%"
      ...
      <div className={``}>
        <div className={`lg:container lg:mx-auto`}>
          <div
            className={`w-full px-5 h-screen flex justify-center items-center`}
          >
            <div>
              <Tween
                from={{ text: texts[0] }}
              ...
              <h2
                className={`pt-[10px] pb-[30px] font-bold text-sm text-center text-white lg:text-xl uppercase`}
              >
                <Tween
                  from={{ text: texts[2] }}
                  to={{ text: texts[3] }}
        ...
        <div className={`bg-white md:bg-black`}>
          <div
            className={`grid grid-cols-1 pb-5 md:pb-0 gap-5 md:gap-0 md:container md:mx-auto md:grid-cols-3`}
          >
        ...
        <div className={`bg-black`}>
          <div className={`lg:container lg:mx-auto px-5 text-slate-100`}>
            <h2 className={`uppercase text-xl font-bold py-10 lg:text-center`}>
              {t({ id: `index.tb_h2` })}
            </h2>
            <div className={`grid grid-cols-1 lg:gap-5 lg:grid-cols-3`}>
              <div>
                <h3 className={`uppercase font-bold leading-normal`}>
                  {t({ id: `index.tb_h3_1` }, { br: <br /> })}
                </h3>
                <div className={`py-4`}>
